...
function inputHandler() {
	...
	let list = [];
	if (!inputVal) {
		swal("Error!", "¡No has ingresado una tarea!", "error");
...
//Funcion para borrar el placeholder del input al hacer clic en el campo//
...
nombreInput.addEventListener('blur', () => {
	nombreInput.setAttribute('placeholder', 'Tarea pendiente...');
  });



  //Validacion de la longitud de caracteres ingresados en el input//
